  ...
  void addMonsters() {
    if ((millis() - lastAddTime) > round(random(newMonsterInterval[0], newMonsterInterval[1])) && addMonsters) {
      for (int i = 0; i < round(random(2)); i++) {
        /* which monster which level */
        if (level < 2) {
          monsters.add(new Monster(0));
        }
        else if (level < 3) {
          monsters.add(new Monster(round(random(0, 1))));
        }
        else if (level < 4) {
          monsters.add(new Monster(round(random(0, 2))));
        }
        else if (level < 5) {
          monsters.add(new Monster(round(random(0, 3))));
        }
        else if (level < 6) {
          monsters.add(new Monster(round(random(0, 4))));
        }
        else {
